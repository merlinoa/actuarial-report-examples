...
We used two actuarial projection techniques (paid projection and incurred projection) in creating the final estimated ultimate loss projection.  The loss projections look at the loss experience for the more mature accident years to predict the development of less mature development years.  Details on the paid projection and incurred projection can be found in Exhibit II, and Exhibit III respectively.
